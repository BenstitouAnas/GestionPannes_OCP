...
<head>
    ...
    <title>Comptes | Liste Demandes Comptes</title>
            ...
            <div class="row wrapper border-bottom white-bg page-heading">
                <div class="col-lg-10">
                    ...
                    <ol class="breadcrumb">
                        ...
                        <li class="active">
                            <strong>Liste Demandes Confirmation</strong>
                        </li>
                    </ol>
                </div>
                <div class="col-lg-2">
								...
								if(isset($_GET['modif']))
								{
									...
									if($nombre == "true")
									{
									 ...
									 <div class="alert alert-success fade in">
										...
										<strong>Success!</strong> Compte confirmé avec succes.
									</div>';
									}
									...
									else if($nombre == "false")
									{
									 ...
									 <div class="alert alert-warning fade in">
										<a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
										<strong>ََAttention!</strong> Compte non confirmé.
									  </div>';
									}
								}
                            ...
                            <table class="footable table table-stripped toggle-arrow-tiny" data-page-size="15">
                                ...
                                <tbody>
									...
									<?php
										...
										$demande = mysqli_query($con,"SELECT * FROM utilisateur WHERE CONFIRM_UTILIS=0");
