...
--
-- Host: 127.0.0.1
-- Generation Time: Jul 29, 2016 at 09:51 AM
...
(3, 'DHL', 'USA 15 St NewYork 1541', 'DHL@DHL.inc', '+9542548121404');
...
(9, 1, 1, 1, 1, 'F014H1', 'DELL Inspiron 500Gb HDD, core 15', '2010-02-02', '2020-12-25', 0, '2010-02-04');
...
(2, 'Votre demanade est en attente', 'demande en attente', '2016-07-22 00:00:00', 1),
(3, 'Bonjour;\r\nLe matérielle HP cire i3 SG154FG55 fournis par votre entreprise et qui''a une garantie jusqu''a le 31-12-2019 est en panne', 'Demande rÃ©paration', '2016-07-03 00:00:00', 1),
(6, 'kokokokoko', 'Votre demande de panne', '2016-07-22 09:35:02', 0),
(7, 'Votre demande de panne N15 Votre demande de panne N15 Votre demande de panne N15 Votre demande de panne N15 ', 'Votre demande de panne N15 Votre demande de panne N15 Votre demande de panne N15 Votre demande de panne N15 ', '2016-07-22 09:36:48', 0),
(8, 'klklklklklk', 'Votre demande de panne', '2016-07-22 09:37:48', 1),
(9, 'jijijijijijiji', 'Demande de rÃ©paration', '2016-07-22 09:40:49', 1),
(10, 'dede', 'de', '2016-07-26 10:01:16', 0),
(11, 'hhhhhhhhhhhhhhhhhhh', 'hihihihi', '2016-07-26 11:39:34', 0),
(12, 'jiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiiii', 'jijijijij', '2016-07-26 11:41:34', 0),
(13, 'kikikikikikikikik', 'jijijijij', '2016-07-26 11:44:04', 0),
(14, 'kikikikikikikikik', 'jijijijij', '2016-07-26 11:44:25', 0),
(15, 'Votre demande N 3 seras traite dans 2 jours', 'Votre demande de panne', '2016-07-27 15:25:08', 1);
...
CREATE TABLE IF NOT EXISTS `utilisateur` (
  ...
  `CONFIRM_UTILIS` smallint(6) NOT NULL,
...
INSERT INTO `utilisateur` (`MATRICULE_UTILIS`, `ID_SERVICE`, `NOM_UTILIS`, `PRENOM_UTILIS`, `DATENAISSANCE_UTILIS`, `ADRESSE_UTILIS`, `TELE_UTILIS`, `EMAIL_UTILIS`, `TYPE_UTILIS`, `MDPS_UTILIS`, `CONFIRM_UTILIS`) VALUES
('M000', 1, 'admin', 'admin', '1995-08-18', 'N11 Rue rachidia, CHEMAIA', '0629830743', 'admin@admin.ocp', 'admin', '$2y$10$QD3P9DUIxkvnzJC6uiQEgu5l5VlGDxA3421iLd6bXwKcUe4Oorbl6', 1),
('M001', 1, 'BENSTITOU', 'Anas', '1995-08-18', 'N11 Rue rachidia, CHEMAIA', '0629830743', 'anasben2013@gmail.com', 'IT', '$2y$10$THTCgChOEfwhIvaxgETiGOemTf7ycI2oM.p.pmDH81UEoxkYNtQ9a', 1),
('M002', 1, 'JABLI', 'Zakaria', '1990-08-18', 'Ocp 8220 YOUSSOUFIA', '0645781523', 'jabli.zakaria@gmail.com', 'agent', '$2y$10$NUvzXl7uUoKfh..J1twPy.AMeEQczb0G9CZ4v.f.ooYnNgj86pnXS', 1);
